...
namespace DXUploadXAFBlazor.Blazor.Server {
    public partial class DXUploadXAFBlazorBlazorApplication : BlazorApplication {
        public DXUploadXAFBlazorBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void DXUploadXAFBlazorBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
